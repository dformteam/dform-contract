...
near call neutrino.testnet publish_form '{"formId": "BKNttCuSxPEocPiRAfZGd21nrHithdvLbEGvbppfmiBhZEwg", "limit_participants": 200, "enroll_fee": "0", "start_date": "1612112400000", "end_date": "1675184400000", "black_list": [], "white_list": []}' --account-id neutrino.testnet
...
near call neutrino.testnet get_form '{\"id\": \"BKNttCuSxPEocPiRAfZGd21nrHithdvLbEGvbppfmiBhZEwg\"}' --account-id neutrino.testnet 
near call neutrino.testnet unpublish_form '{\"formId\": \"BKNttCuSxPEocPiRAfZGd21nrHithdvLbEGvbppfmiBhZEwg\"}' --account-id neutrino.testnet --gas=300000000000000

near call neutrino.testnet publish_form '{\"formId\": \"BKNttCuSxPEocPiRAfZGd21nrHithdvLbEGvbppfmiBhZEwg\", \"limit_participants\": 200, \"enroll_fee\": \"1000000000000000000000000\", \"start_date\": \"1643461271000\", \"end_date\": \"1643461274277\", \"black_list\": [], \"white_list\": []}' --account-id neutrino.testnet --gas=300000000000000

near call neutrino.testnet new_element '{\"formId\": \"BKNttCuSxPEocPiRAfZGd21nrHithdvLbEGvbppfmiBhZEwg\", \"type\": 1, \"title\": \"q_test2222333\", \"meta\": \"123123; 3123123\"}' --account-id neutrino.testnet --gas=300000000000000
near call neutrino.testnet get_element '{\"formId\": \"BKNttCuSxPEocPiRAfZGd21nrHithdvLbEGvbppfmiBhZEwg\", \"index\": 1}' --account-id neutrino.testnet --gas=300000000000000
near call neutrino.testnet join_form '{\"formId\": \"BKNttCuSxPEocPiRAfZGd21nrHithdvLbEGvbppfmiBhZEwg\"}' --account-id neutrino.testnet --deposit 1 --gas=300000000000000
near call neutrino.testnet get_participant_detail '{\"formId\": \"BKNttCuSxPEocPiRAfZGd21nrHithdvLbEGvbppfmiBhZEwg\", \"userId\":\"neutrino.testnet\"}' --account-id neutrino.testnet --gas=300000000000000
near call neutrino.testnet get_participants_detail '{\"formId\": \"BKNttCuSxPEocPiRAfZGd21nrHithdvLbEGvbppfmiBhZEwg\", \"page\":0}' --account-id neutrino.testnet --gas=300000000000000
near call neutrino.testnet update_participant_status '{\"formId\": \"BKNttCuSxPEocPiRAfZGd21nrHithdvLbEGvbppfmiBhZEwg\", \"userId\":\"neutrino.testnet\", \"status\":0}' --account-id neutrino.testnet --gas=300000000000000
near call neutrino.testnet get_enroll_fee '{\"formId\": \"BKNttCuSxPEocPiRAfZGd21nrHithdvLbEGvbppfmiBhZEwg\"}' --account-id neutrino.testnet
near call neutrino.testnet set_enroll_fee '{\"formId\": \"BKNttCuSxPEocPiRAfZGd21nrHithdvLbEGvbppfmiBhZEwg\", \"new_fee\": \"1000000000000000000000000\"}' --account-id neutrino.testnet
near view neutrino.testnet get_participants '{"formId": \"BKNttCuSxPEocPiRAfZGd21nrHithdvLbEGvbppfmiBhZEwg\", \"page\": 1}' --account-id neutrino.testnet
near call neutrino.testnet claim_reward '{\"formId\": \"BKNttCuSxPEocPiRAfZGd21nrHithdvLbEGvbppfmiBhZEwg\"}' --account-id neutrino.testnet
